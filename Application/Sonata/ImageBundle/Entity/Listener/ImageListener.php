...
namespace Application\Sonata\ImageBundle\Entity\Listener;
...
class ImageListener
{
    ...
    private function moveFile(LifecycleEventArgs $args)
    {
        ...
        if ($image instanceof Image) {
            ...
            if ($this->container->hasParameter("cdn_host")) {
                $cdnHost = $this->container->hasParameter("cdn_host");
                if ($cdnHost) {
                    $web_folder = $cdnHost;
                }
            }

            $web_folder .= "/" . self::UPLOAD_FOLDER;
